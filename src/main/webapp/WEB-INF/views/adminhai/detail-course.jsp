    ...
    ***********************************-->
			...
			<div class="content-body">
				...
				<div class="container-fluid">
									...
									<div class="card">
										...
										<div class="card-body pb-0">
											...
											<ul class="list-group list-group-flush">
												...
												<li class="list-group-item d-flex px-0 justify-content-between">
													<strong>Professor</strong> <span class="mb-0">
														<c:forEach items="${course.listTeacher}" var="dataItem">
															${dataItem.firstName}
														</c:forEach>
															...
															<li class="nav-item">
																<h3 class="mb-1 text-primary">
																	...
																	<c:forEach items="${lesson}" var="dataItem">
																		<c:set var="studenttotal"
																			value="${studenttotal+1}" />
																	</c:forEach>
																	${studenttotal}
																</h3> <a href="#about-me" data-toggle="tab"
																	class="nav-link"
																	style="margin-left: 30px"><span>lesson</span></a>
															</li>
															<li class="nav-item">
																<h3 class="mb-1 text-primary">
																	<c:set var="studenttotal" value="${0}" />
																	<c:forEach items="${course.listStudent}"
																		var="dataItem">
																		<c:set var="studenttotal"
																			value="${studenttotal+1}" />
																	</c:forEach>
																	${studenttotal}
																</h3> <a href="#my-posts" data-toggle="tab"
																	class="nav-link"
																	style="margin-left: 20px"><span>Students</span></a>
															</li>
																			...
																			<tr>
																				...
																				<td>
																					<div class="popup_main">
																						<button
																							class="open_popup">update</button>
																							...
																							<div class="popup_contain">
																								...
																								<form
																									...
																									<div
																										...
																										<div
																											class="form-group fallback w-100">
																											<input
																												type="file"
																												name="uploadfile">
																										</div>
																									...
																									<div
																										...
																										<button
																											type="submit"
																											class="btn btn-light">Cencel</button>
																									</div>
																								</form>
																							</div>
																						</div>
																	...
																	<tbody>
																		...
																		<c:forEach items="${course.listStudent}"
																			...
																			<tr>
																				...
																				<td>${item.email}</td>
																				<td><a
																						href="javascript:void(0);"><strong>${item.createDate}</strong></a>
																				</td>
					...
					<div class="row" style="justify-content: space-around;">
						<a href="${pageContext.request.contextPath}/admin/edit-course?id=${course.id}"><button
        ...
        ***********************************-->
			<div class="footer">
				<div class="copyright">
					<p>
						Copyright © Designed &amp; Developed by <a href="http://dexignlab.com/"
							target="_blank">DexignLab</a> 2020
					</p>
				</div>
			</div>
			<!--**********************************
		...
		<div class="modal fade videopopup" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<button type="button" class="close videobtn" data-dismiss="modal" aria-label="Close">
