...
<link rel="stylesheet" href="<c:url value='/resources/main/css/video.css'/>" type="text/css">
...
.link:hover {
 ...
 <body>
	...
	<div id="wrapper">
      ...
      <video controls class="video" id="video" preload="metadata" poster="<c:url value='/resources/upload/video/course-1/poster.jpg'/>">
        <source src="<c:url value='/resources/upload/video/${lesson.video }'/>" type="video/mp4"></source>
      </video>
	...
	<script>
		function myFunction() {
            ...
            document.cookie = "progress=" + percent;
            document.cookie = "lessonId=" + ${lesson.id}; 
		}	
		window.onunload = function(){ 
            myFunction();
		};	
 	</script>
	<script src=" <c:url value='/resources/main/js/video.js'/>"></script>
