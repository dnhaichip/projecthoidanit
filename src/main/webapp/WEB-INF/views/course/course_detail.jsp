                ...
                <div class="row course-list teacher-list">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="shop-item-list entry">
                            <div class="">
                                <img src="${pageContext.request.contextPath }/resources/upload/xcourse_01.png.pagespeed.ic.XTOvCuUmZu.png" alt="">
                                <div class="magnifier">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-md-6">
                        <div class="shop-list-desc">
                            ...
                            <div class="shopmeta">
                                <span class="pull-left"><strong>Teacher :</strong> Teacher 1 </span>
                            </div>
                    ...
                    <div class="col-md-3 text-right">
                        <a href="book_detail.html" class="btn btn-primary btn-lg">enrollment</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row course-list teacher-list">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="shop-item-list entry">
                            <div class="">
                                <img src="${pageContext.request.contextPath }/resources/upload/images/books/EnglishKidsBox.jpg" alt="">
                                <div class="magnifier">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-md-6">
                        <div class="shop-list-desc">
                            ...
                            <div class="shopmeta">
                                <span class="pull-left"><strong>Book :</strong> Book 1 </span>
                            </div>
                            <hr class="invis clearfix">
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                                has
                    ...
                    <div class="col-md-3 text-right">
                        <a href="book_detail.html" class="btn btn-primary btn-lg">Read more</a>
                    </div>
                </div>
            </div>
